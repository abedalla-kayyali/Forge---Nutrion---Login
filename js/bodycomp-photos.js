...
function _photoFullView(id) {
  _photoDb.getAll().then(photos => {
    ...
    ov.innerHTML = `<img src="${p.data}" style="max-width:92vw;max-height:80vh;border-radius:10px;object-fit:contain;"><div style="color:#ccc;font-family:DM Mono,monospace;font-size:12px;">${p.date}</div>`;
