  ...
  window._syncPull = async function (userId) {
    ...
    try {
      const [
        ...
        window._sb.from('profiles').select('data').eq('id', userId).single(),
        ...
        window._sb.from('settings').select('data').eq('user_id', userId).single(),
        window._sb.from('meals').select('data').eq('user_id', userId).single(),
        window._sb.from('meal_library').select('data').eq('user_id', userId).single(),
